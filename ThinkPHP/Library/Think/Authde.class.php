...
class Authde
{
    ...
    protected $_config = array(
        ...
        'AUTH_GROUP'        => 'auth_group', // 用户组数据表名(角色组)
    ...
    public function getGroups($uid)
    {
        ...
        $sql="select u.id as uid,u.department_id,d.group_id,g.title,g.rules from bt_users as u
INNER JOIN bt_role_department as d on u.department_id=d.id
INNER JOIN bt_auth_group as g on d.group_id = g.id
where u.id={$uid}";
