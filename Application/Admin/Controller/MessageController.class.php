...
//        $model=new MessageModel();
    ...
    * */
    public function del_luchi()
    {
        ...
        if($res){
            $this->success('删除成功',U('message/luchi'));
        }else{
            $this->error('删除失败');
        }
    }
    ...
    * */
    public function del_oben()
    {
        ...
        if($res){
            $this->success('删除成功',U('message/oben'));
        }else{
            $this->error('删除失败');
        }
    }
