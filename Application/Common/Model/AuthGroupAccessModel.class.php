...
class AuthGroupAccessModel extends BaseModel{
	...
	public function getAllData(){
		$data=$this
			->field('u.id,u.department_id,u.username,u.email,u.phone,u.company,u.status,u.last_login_ip,u.last_login_time,u.login_count,u.level,aga.group_id,ag.title')
			->alias('aga')
